...
plt.figure(0)
plt.plot(range(epochs),history2.history['acc'])
plt.plot(range(epochs),history2.history['val_acc'])
...
print(np.mean(history2.history['acc']))
print(np.mean(history2.history['val_acc']))

plt.figure(1)
plt.plot(range(epochs),history2.history['loss'])
plt.plot(range(epochs),history2.history['val_loss'])
...
plt.ylabel('accuracy')
plt.xlabel('epoch')
plt.legend(['3 layer model', '4 layer model'], loc='upper right')
plt.savefig('figures/q5c.png')
